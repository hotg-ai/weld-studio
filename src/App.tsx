...
class App extends React.Component<{}, AppState> {
  ...
  render() {
    const { isLoadingTable, data, queryError, sql, tables } = this.state;
    return (
      <div className="App">
        ...
        <div className="dashboard__container">
          <Router>
            <Routes>
              <Route path="/dataset/:id" element={<Dataset data={data} queryError={queryError} sql={sql} setSql={(sql: string) => this.setState({ sql })} tables={tables} />} />
